        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $currentPage === 'profil' ? 'active' : '' ?>" href="<?= BASE_URL ?>/admin/profil.php">
                            <i class="bi bi-person-lines-fill me-1"></i>Profil
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $currentPage === 'keuangan' ? 'active' : '' ?>" href="<?= BASE_URL ?>/admin/keuangan.php">
